...
export default function Admin({ username, password }) {
  ...
  const ChatMessage = React.memo(({ message, activeFriend, groupId }) => {
    ...
    const date =
      ...
      return !deleted ? (
        <div className={`flex space-x-2 space-y-2 group`}>
          <img
            className={`mb-1 mt-auto h-4 w-4 rounded-full ring-2 ring-blue-500 dark:ring-indigo-60`}
            src={photoURL}
            alt=""
          />
          {text ? (
          ...
          {file && (
            <div
              className={`flex w-60 rounded-md p-2 text-gray-100 color`}
            >
          ...
          {audio && (
            <div
              className={`w-64 rounded-md p-2 pb-0 text-gray-100 color`}
            >
        ...
        <div className={`flex space-x-2 space-y-2 `}>
          <img
            className={`mb-1 mt-auto h-4 w-4 rounded-full ring-2 ring-blue-500 dark:ring-indigo-600`}
            src={photoURL}
            alt=""
          />
