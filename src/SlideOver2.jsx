    ...
    <Transition.Root show={state} as={Fragment}>
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="fixed top-14 inset-y-0 right-0 max-w-full flex">
            <Transition.Child
              as={Fragment}
            ...
            >
              <div className="relative w-screen max-w-xs sm:max-w-md">
                <div className="h-full flex flex-col py-5 bg-gray-50 dark:bg-slate-900 shadow-xl overflow-hidden">
                  {content}
                </div>
              </div>
            </Transition.Child>
